...
export const queries = {
  ...
  createClientsTable:
    "USE [master] IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='tb_clients' and xtype='U') BEGIN CREATE TABLE tb_clients (Id INT PRIMARY KEY IDENTITY (1, 1), Name VARCHAR(50), lastName VARCHAR(50), City VARCHAR(50), Address VARCHAR(255), postalCode VARCHAR(50)) END",
